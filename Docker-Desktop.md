...
***Instalación verificada en Ubuntu*** 

**Para la instalación de docker desktop se deben seguir unos pasos para evitar conflictos. Contiene lo necesario para no tener que instalar otras herramientas docker.**
...
- (Verificación que no esta instalado en el sistema) Desistalación de Docker-Desktop: 
```
...
- Clave GPG (Necesario para iniciar sesión posteriormente a la instalación) (Obligatorio si es la primera vez que instala Docker-Desktop)
```
...
- Dirijirse a la carpeta Descargas para ejecutar archivo .deb, e introducir:
```
sudo apt-get update
...
Puede consultar en la documentación de docker para mas información:
